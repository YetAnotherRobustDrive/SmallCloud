...
class LabelControllerTest {
    ...
    @Nested
    @DisplayName("/labels/remove 파일에서의 라벨 제거 테스트")
    class remove {
        private final String url = URL_PREFIX + "/remove";
        private LabelDto labelDto;
        @BeforeEach
        void boot() {
            labelDto = LabelDto.builder()
    ...
    @Nested
    @DisplayName("labels/attach 파일에 라벨 붙이기 테스트")
    class attach {
        private final String url = URL_PREFIX + "/attach";
        private LabelDto labelDto;
        private LabelDto noLabelNameDto;
        private LabelDto noOwnerDto;
        private LabelDto noFileDto;
